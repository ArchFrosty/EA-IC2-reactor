...
public class ReactorPlannerFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        temperatureAndComponentsPanel = new JPanel();
        temperatureEffectsLabel = new JLabel();
        ...
        selectedComponentLabel = new JLabel();
        jLabel12 = new JLabel();
        ...
        resourcePackItem.addActionListener(new ActionListener() {
        ...
        temperatureAndComponentsPanel.setLayout(new GridBagLayout());
        ...
        componentHeatSpinner.setModel(new SpinnerNumberModel(0, 0, 360000, 1));
        ...
        euReactorRadio.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        fluidReactorRadio.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        heatSpinner.setModel(new SpinnerNumberModel(0.0d, 0.0d, 10000.0d, 1.0d));
        ...
        pasteCodeButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        onPulseSpinner.setModel(new SpinnerNumberModel(30, 0, 5000000, 1));
        ...
        offPulseSpinner.setModel(new SpinnerNumberModel(30, 0, 5000000, 1));
        ...
        suspendTempSpinner.setModel(new SpinnerNumberModel(8400, 0, 100000, 1));
        ...
        resumeTempSpinner.setModel(new SpinnerNumberModel(0, 0, 100000, 1));
        ...
        automationPanel.setLayout(new GridBagLayout());
        ...
        thresholdSpinner.setModel(new SpinnerNumberModel(9000, 0, 360000, 1));
        ...
        pauseSpinner.setModel(new SpinnerNumberModel(1, 0, 10000, 1));
